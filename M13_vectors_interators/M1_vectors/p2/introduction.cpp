/*
    ...
    We can also insert elements into a vector (we'll insert elements a little later in the lesson).
    ...
    Since we can add elements anywhere in the vector, we do not refer to the first element of a vector as the zero element, we call it the beginning.
