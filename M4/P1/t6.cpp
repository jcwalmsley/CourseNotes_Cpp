/*
    ...
    1) Do you want a pet with fur(f), featers(t), or scales(s)? Confirm choice, You wanta pet with ____. 2) Do you want the pet to live in water(w), on land(l), or both(b)?
